...
(function (_) {
    ...
    _.Na = function (a, b) {
        ...
        bc = function (a) {
            var b = a;
            if (a instanceof Array) {
                b = Array(a.length), _.ac(b, a); } else if (a instanceof Object) {
                var c = b = {}, d;
                for (d in a) {
        ...
        sg = function (a, b) {
            ...
            a = _.Bf(f);
            var g = null;
            _.R && qg(e.useStaticMap, a) && (g = new jg(
                f,
                _.rg,
                _.L(_.tf(_.R), 9),
                new Nd(null)
            ), _.y.forward(g, "staticmaploaded", this), g.set("size", a), g.bindTo("center", this), g.bindTo("zoom", this), g.bindTo("mapTypeId", this), g.bindTo("styles", this));
        ...
        Dg = function () {
            ...
            7 == this.type && (b = /^Mozilla\/.*Gecko\/.*[Minefield|Shiretoko][ /]?([0-9]+).?([0-9]+)?/, d = b.exec(this.l)) && (this.type = 5, this.version = new Ag((0, window.parseInt)(
                d[1],
                10
        ...
        _.k.setAt = function (a, b) {
            ...
            if (a < d) {
                this.b[a] = b, _.y.trigger(this, "set_at", a, c), this.l && this.l(a, c); } else {
                for (c = d; c < a; ++c) {
